...
class TasSlider extends StatefulWidget {
  const TasSlider({Key key, this.onChangedistValue, this.distValue})
      : super(key: key);
  ...
  @override
  _TasSliderState createState() => _TasSliderState();
}

class _TasSliderState extends State<TasSlider> {
