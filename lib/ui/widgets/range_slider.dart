...
class TasRangeSlider extends StatefulWidget {
  const TasRangeSlider({Key key, this.values, this.onChangeRangeValues})
      : super(key: key);
  ...
  @override
  _TasRangeSliderState createState() => _TasRangeSliderState();
}

class _TasRangeSliderState extends State<TasRangeSlider> {
  RangeValues _values;
